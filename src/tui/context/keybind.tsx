...
const DEFAULT_KEYBINDS: KeybindDef[] = [
  ...
  { id: "session_parent", default: "ctrl+u", description: "Go to parent session", category: "Session" },
  { id: "session_child_first", default: "ctrl+o", description: "View subagents", category: "Session" },
  { id: "session_child_cycle", default: "ctrl+]", description: "Next child session", category: "Session" },
  { id: "session_child_cycle_reverse", default: "ctrl+[", description: "Previous child session", category: "Session" },
  { id: "session_share", default: "ctrl+shift+s", description: "Share session", category: "Session" },
  { id: "session_export", default: "ctrl+shift+e", description: "Export session", category: "Session" },
  { id: "session_timeline", default: "ctrl+t", description: "Jump to message", category: "Session" },
  { id: "session_fork", default: "ctrl+shift+f", description: "Fork session", category: "Session" },
  { id: "session_compact", default: "ctrl+shift+c", description: "Compact session", category: "Session" },
  { id: "messages_undo", default: "ctrl+z", description: "Undo last message", category: "Session" },
  { id: "messages_redo", default: "ctrl+shift+z", description: "Redo", category: "Session" },
  { id: "messages_copy", default: "ctrl+shift+y", description: "Copy last assistant message", category: "Session" },
  { id: "messages_next", default: "ctrl+down", description: "Next message", category: "Session" },
  { id: "messages_previous", default: "ctrl+up", description: "Previous message", category: "Session" },
  ...
  { id: "sidebar_toggle", default: "ctrl+b", description: "Toggle sidebar", category: "View" },
  { id: "display_thinking", default: "ctrl+shift+t", description: "Toggle thinking", category: "View" },
  { id: "tool_details", default: "ctrl+shift+d", description: "Toggle tool details", category: "View" },
  { id: "messages_toggle_conceal", default: "ctrl+shift+v", description: "Toggle code conceal", category: "View" },
